def makeConfigFile(dataset,  data, uidir, dir, sample):
    ...
    config+='pset = rootTupleMaker_CRAB_MC_SIG_2012_53X_cfg.py\n'
    config+='\n'
    config+='### Splitting parameters\n'
    config+='total_number_of_events=-1\n'
    config+='events_per_job = 2000\n'
    config+='\n'
